...
class R {
  /// package name: tower_defense
  static const package = "tower_defense";
...
class _R_Image_AssetResource {
  ...
  final air = const AssetResource("assets/images/air.png", packageName: null);

  /// asset: assets/images/electricity.png
  // ignore: non_constant_identifier_names
  final electricity = const AssetResource("assets/images/electricity.png", packageName: null);

  /// asset: assets/images/fire.png
  // ignore: non_constant_identifier_names
  final fire = const AssetResource("assets/images/fire.png", packageName: null);

  /// asset: assets/images/ice.png
  // ignore: non_constant_identifier_names
  final ice = const AssetResource("assets/images/ice.png", packageName: null);
}
...
class _R_Image {
  ...
  // ignore: non_constant_identifier_names
  AssetImage air() {
    return AssetImage(asset.air.keyName);
  }

  /// asset: assets/images/electricity.png
  // ignore: non_constant_identifier_names
  AssetImage electricity() {
    return AssetImage(asset.electricity.keyName);
  }

  /// asset: assets/images/fire.png
  // ignore: non_constant_identifier_names
  AssetImage fire() {
    return AssetImage(asset.fire.keyName);
  }

  /// asset: assets/images/ice.png
  // ignore: non_constant_identifier_names
  AssetImage ice() {
    return AssetImage(asset.ice.keyName);
  }
}
