  ...
  group('路徑測試', () {
    ...
    group('不可擋住入口及出口測試', () {
      ...
      test('擋住出口', () {
        ...
        expect(manager.buildingsManager.buildings.length, 2, reason: '因為3個都放置後出口會被擋住，所以成功放置的建築只會有2個');
      });
      ...
      test('擋住入口', () {
        ...
        expect(manager.buildingsManager.buildings.length, 2, reason: '因為3個都放置後入口會被擋住，所以成功放置的建築只會有2個');
      });
    });
